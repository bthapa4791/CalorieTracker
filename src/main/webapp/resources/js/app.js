...
myapp.config(function ($routeProvider, USER_ROLES) {
    ...
    $routeProvider.when("/home", {
        ...
        templateUrl: 'resources/partials/apiDoc.html',
        ...
        templateUrl: 'resources/partials/tokens.html',
    	...
    	templateUrl: 'resources/partials/meal.html',
...
myapp.run(function ($rootScope, $location, $http, AuthSharedService, Session, USER_ROLES, $q, $timeout) {
    ...
    $rootScope.$on('event:auth-loginConfirmed', function (event, data) {
        ...
        $timeout(function () {
            ...
            console.log('login confirmed start ' + $rootScope.account.userRoles);
